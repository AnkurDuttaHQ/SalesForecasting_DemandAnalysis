...
overall = pd.read_csv(DATA_DIR / "overall_prophet_forecast.csv")
furniture = pd.read_csv(DATA_DIR / "furniture_forecast.csv")
technology = pd.read_csv(DATA_DIR / "technology_forecast.csv")
office = pd.read_csv(DATA_DIR / "office_forecast.csv")
west = pd.read_csv(DATA_DIR / "west_forecast.csv")
east = pd.read_csv(DATA_DIR / "east_forecast.csv")
